...
export const TOOLS: Tool[] = [
  {
    ...
    blurb: "The moment the request is created. Drop actions or approvals on it to run them immediately.",
    kind: "trigger",
  ...
  },
  {
    ...
    icon: "flag",
    category: "When it starts",
    blurb: "Fires automatically when the ticket status changes to a specific state.",
    kind: "trigger",
  ...
  },
  {
    ...
    icon: "priority_high",
    category: "When it starts",
    blurb: "Fires automatically when the ticket priority is updated (e.g. upgraded to Urgent).",
    kind: "trigger",
  ...
  },
  {
    ...
    icon: "verified",
    category: "When it starts",
    blurb: "Fires when an approval node in the flow is decided (approved or rejected).",
    kind: "trigger",
